...
* For local audio functionality, run the app directly on your host machine as described in the Usage section (i.e., using `python main.py` or `streamlit run app.py`) instead of inside Docker.
